...
namespace AttandanceSyncApp.Repositories
{
    public class AuthUnitOfWork : IAuthUnitOfWork
    {
        ...
        // ===== ONLY NEW ADD FOR USER APPROVAL =====
        private IRepository<UserApprovalStatus> _userApprovalStatusRepository;

        public IRepository<UserApprovalStatus> UserApprovalStatus =>
            _userApprovalStatusRepository ??
            (_userApprovalStatusRepository = new Repository<UserApprovalStatus>(_context));
        // ==========================================
